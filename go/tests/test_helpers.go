...
func (m *MockSecurityProvider) AllowedActions(ifs.IVNic, string) map[string][]int32 {
	return nil
}
...
func (m *MockSecurityProvider) NewSystemConfig() *l8sysconfig.L8SysConfig {
	return nil
}

func (m *MockSecurityProvider) AddAdjacent(ifs.ISecurityProvider) {}
